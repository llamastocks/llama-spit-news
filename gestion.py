...
sections=[("ultimas-noticias","Ultimas noticias")]
for section in sections:
    url="https://www.gestion.pe/"+section[0]
    contenido=requests.get(url, verify=False).text

    soup=BeautifulSoup(contenido,"html.parser")
    p=soup.find_all("div",{"class":"story-item__information-box w-full"})
